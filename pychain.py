...
sender_1 = st.text_input("Sender ID")

# Add an input area where you can get a value for `receiver` from the user.
receiver_1 = st.text_input("Reciever ID")


# Add an input area where you can get a value for `amount` from the user.
amount_1 = st.text_input("Amount of Transaction")
...
if st.button("Add Block"):
    ...
    new_block = Block(
        # data=input_data,
        record = Record(sender_1,receiver_1,amount_1),
        creator_id=42,
